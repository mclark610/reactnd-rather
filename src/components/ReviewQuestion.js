...
class ReviewQuestion extends React.Component {
    ...
    render() {
        console.log("user : " + this.props.authedUser + "voted for optionOne? " + this.props.question.optionOne.votes.filter( (vote)=> vote===this.props.authedUser).length )
        console.log("user : " + this.props.authedUser + "voted for optionTwo? " + this.props.question.optionTwo.votes.filter( (vote)=> vote===this.props.authedUser).length )
        // check if authedUser voted for optionOne:
        console.log("optionOne: " + this.state.optionOne)
        console.log("optionTwo: " + JSON.stringify(this.state.optionTwo))
...
function mapStateToProps({authedUser,questions,users},ownProps) {
    ...
    console.log("mapState:questionID: " + JSON.stringify(ownProps.match.params.id))

    console.log("authedUser: " + JSON.stringify(authedUser))
    console.log("mapState:question: " + JSON.stringify(question))
